...
import { IoIosMore, IoSettingsOutline, IoLogOutOutline } from "react-icons/io5";
...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div className={isVisible ? "navbar visible" : "navbar"}>
                ...
                <div className="last-list-item">
                    <p className="list-item-paragraph">
                        <VscListFlat className="list-icon" />
                        GROCERY LIST</p>
                    <IoMdMore className="more-icon" onClick={toggleModifyListPopup} />
                    <p className="add-icon-list" onClick={toggleAddPopup} >+</p>
                </div>
                ...
                <div className="team-list">
                    ...
                    <IoMdMore className="more-icon" onClick={toggleModifyTeamListPopup} />
            ...
            {/* New div for Meredith Grey */}
            <div className="meredith-grey">
                <IoSettingsOutline className="settings-icon" />
                <IoLogOutOutline className="logout-icon" />
            </div>
            <AddPopup isOpen={isAddPopupVisible} onClose={toggleAddPopup}></AddPopup>
            <ModifyListPopup isOpen={isModifyListPopupVisible} onClose={toggleModifyListPopup}></ModifyListPopup>
            <AddTeamsPopup isOpen={isAddTeamsPopupVisible} onClose={toggleAddTeamsPopup}></AddTeamsPopup>
            <ModifyTeamListPopup isOpen={isModifyTeamListPopupVisible} onClose={toggleModifyTeamListPopup}></ModifyTeamListPopup>
        </>
    );
};
